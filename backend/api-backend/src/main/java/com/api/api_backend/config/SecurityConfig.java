package com.api.api_backend.config;
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http
				...
				.authorizeHttpRequests((requests) -> requests
						.requestMatchers("/api/login" , "/api/cadastro").permitAll() // pode ser acessado sem autenticação
						// .requestMatchers("/api/register").permitAll() // pode ser acessado sem
						// autenticação
